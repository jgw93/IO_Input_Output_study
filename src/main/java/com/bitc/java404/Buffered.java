...
public class Buffered {
    ...
    public void buffReaderEx() throws Exception{
        // 키보드 입력 받기, 1byte 씩 데이터를 받음
        InputStream is = System.in;
        // InputStreamReader 의 생성자에 InputStream 객체를 사용함, 1문자씩 읽어오는 형태로 변환
        Reader reader = new InputStreamReader(is);
        // InputStreamReader 를 BufferedReader 에 입력하여 사용, 입력 속도가 빨라짐
